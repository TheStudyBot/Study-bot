const subjects = {
	"Mechanics": {
			"U-1: Resolution and Composition of Forces": {
				...
				"video": ["https://youtube.com/playlist?list=PLruTCQ0dsWzG3jalpEvWVjq27y9vVLHBC&si=08gGad7uYvCb_GY6"]
			},
	...
	"Physics": {
			"U-1: Wave Optics": {
				...
				"video": ["https://youtu.be/Vp6D1KW7jRM?si=rK-4KMzJt33x7ZDp","https://youtube.com/playlist?list=PLq6b-r81cS_yAKZkGsUy3NAzjI7XXgDfc&si=0uPEftiAlDl-Jwbt"]
			},
	...
	"BEE": {
			"U-1: Electromagnetism": {
				"pdf": ["/path/to/sme/chapter_6_notes.pdf"],
				"video": ["https://youtube.com/playlist?list=PLAcdVFEsjGl5lI2CtBtnTC6_q-StRNEWt&si=3CM0LjxgY5c5FMTb"]
			},
	...
	"Graphics": {
			...
			"U-3: Engineering Curves": {
				"pdf": ["/path/to/sme/chapter_6_notes.pdf"],
				"video": ["https://youtube.com/playlist?list=PLDN15nk5uLiCvq_1LLbWXO93hj62ChaVY&si=I_Cd1l4kmFxdxa1Z"]
			},
			"U-4: Orthographic Projection": {
				"pdf": ["/path/to/sme/chapter_6_notes.pdf"],
				"video": ["https://youtube.com/playlist?list=PLDN15nk5uLiBpnIOK5r3KXdfFOVzGHJSt&si=rwJhcPZWAU4U3mW5"]
			},
			"U-5: Isometric Projection ": {
				"pdf": ["/path/to/sme/chapter_6_notes.pdf"],
				"video": ["https://youtube.com/playlist?list=PLDN15nk5uLiCf-raL06kSCeqR8h61eYIC&si=qG2aj1ko49UPPOHi"]
			},
			"U-6: Development of Lateral Surfaces": {
				"pdf": ["/path/to/sme/chapter_6_notes.pdf"],
				"video": ["https://youtube.com/playlist?list=PLyIqv0Q_BYJpZgPbzGobqubidmZ1uWG4B&si=ZRPY3pOO4dKj1tBk"]
			}
		},
	"Chemistry": {
			"U-1: Water Technology": {
				"pdf": ["/path/to/sme/chapter_6_notes.pdf"],
				"video": ["https://youtube.com/playlist?list=PLLf6O8XdGj03gLo6znlqJbMzgIgt8tSU1&si=0vX1vUfmOfACqdP7"]
			},
	...
	"PPS": {
			"U-1: Problem Solving, Programming and Python Programming": {
				"pdf": ["/path/to/sme/chapter_6_notes.pdf"],
				"video": ["https://youtu.be/4AFY3NyPLzQ?si=m8bh1qNqiJLWaSgM", "https://youtu.be/8GrMwZOZwVc?si=azFq84ziVGYRuoui"]
			},
...
function displayStudyMaterials() {
    ...
    if (subjectData) {
        ...
        for (let i = 0; i < subjectData.video.length; i++) {
            sendMessage("<a href='" + subjectData.video[i] + "' target='_blank'>Watch Video Lecture " + (i + 1) + "</a>", "bot");
        }
    } else {
...
function displayWelcomeMessage() {
    var welcomeMessage = "<b>The Study Bot</b> welcomes you! 1)Type the <mark>name of the subject</mark> & 2)Type the <mark>number of the unit.</mark> SUBMIT USING ENTER KEY ON KEYBOARD<br> Select a subject:";
    welcomeMessage += "<ol>";
